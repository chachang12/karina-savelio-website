...
const ServicesCard = ({ service }) => {
  ...
  return (
    <div className="relative bg-white p-6 rounded-xl shadow-lg w-full md:w-[300px] h-[350px] flex flex-col justify-between transition-colors duration-300 hover:bg-sage hover:bg-opacity-20">
      <div>
      ...
      <div className="relative z-10 p-4 overflow-x-auto scrollbar-hide hidden md:block">
