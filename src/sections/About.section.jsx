...
const About = () => {
  return (
    <div className="flex flex-col justify-center items-center">
        <span className='mx-auto text-[40px] md:text-[50px] font-semibold text-sage '>
            About Me
        </span>
        <hr className="border-b border-sage my-2 w-12 mx-auto" />
        <div className='flex flex-col md:flex-row justify-center items-center gap-10 my-6 w-[80%] md:w-[60%]'>
            <div className="mb-6 md:mb-0">
                <img src={karinaImage} alt="Karina Savelio" className="w-[200px] md:w-[300px] h-auto rounded-full" />
            </div>
            <div className="md:w-2/3 p-4">
                <h2 className="text-2xl md:text-3xl font-bold text-mintGreen mb-4">Who am I?</h2>
